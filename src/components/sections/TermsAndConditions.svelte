<section class="container">
  ...
  <article>
    ...
    <ul>
      ...
      <li>Agenda - ustalony przez Organizatora program Konferencji, udostępniony w Serwisie po ustaleniu części lub wszystkich Prelegentów. Agenda ma charakter orientacyjny i może ulegać zmianom.
      </li>
      <li>Platforma sprzedażowa - strona internetowa dostępna pod adresem <a href="https://app.easycart.pl/checkout/confrontjs/confrontjs">https://app.easycart.pl/checkout/confrontjs/confrontjs</a>, do której następuje przekierowanie z Serwisu, za pośrednictwem której możliwe jest dokonanie Zgłoszenia do udziału w Konferencji oraz płatność za bilet uprawniający do udziału. Właścicielem Platformy EasyCart jest Eduweb spółka z ograniczoną odpowiedzialnością z siedzibą w Warszawie (02-972) przy Al. Rzeczypospolitej 10 lok. 46
      </li>
      <li>Prelegent - osoba fizyczna, zaproszona do wygłoszenia prelekcji podczas Konferencji</li>
      <li>Polityka Prywatności - dokument dostępny w Serwisie, określający zasady, cele i podstawy przetwarzania danych osobowych Użytkowników, Uczestników i Prelegentów, jak również uprawnienia osób, których dane dotyczą oraz inne informacje dotyczące przetwarzania danych osobowych w Serwisie.</li>
      <li>Regulamin - niniejszy regulamin</li>
      <li>Uczestnik - posiadający pełną zdolność do czynności prawnych Użytkownik uprawniony do udziału w Konferencji oraz uzyskania świadczeń dodatkowych, określonych w Regulaminie, na podstawie umowy o udział w Konferencji zawartej pomiędzy Organizatorem a Zgłaszającym na zasadach określonych w Regulaminie. Użytkownik nieposiadający pełnej zdolności do czynności prawnych, w szczególności osoba niepełnoletnia, może być Uczestnikiem wyłącznie za zgodą przedstawiciela ustawowego, pod warunkiem, że przedstawiciel ten będzie sprawował opiekę nad takim Użytkownikiem, a na jego udział w Konferencji wyrazi zgodę Organizator. </li>
  ...
  <article>
    ...
    <ol>
      <li> Niniejszy Regulamin określa warunki korzystania z Serwisu, a także szczegółowe prawa i
        ...
        <li>Wszelkie prawa do nazwy Serwisu, jego koncepcji graficznej i funkcjonalnej, a także prawa do wszelkich elementów tekstowych i graficznych wykorzystanych w Serwisie, za wyjątkiem elementów, do których prawa przysługują osobom trzecim (w szczególności logotypów partnerów, partnerów medialnych, sponsorów, konferencji partnerskich, etc.), przysługują Organizatorowi i z zastrzeżeniem powszechnie obowiązujących przepisów prawa mogą być wykorzystywane jedynie w oparciu o zgodę (licencję) udzieloną przez Organizatora.</li>
        <li>W sprawach związanych z korzystaniem z Serwisu lub uczestnictwem w Konferencji można skontaktować się z Organizatorem poprzez pocztę e-mail, pod adresem: <a href="mailto: contact@warsawjs.com">contact@warsawjs.com.</a></li>
        <li>Zapoznanie się z Regulaminem oraz Polityką Prywatności jest wymogiem do dokonania
          Zgłoszenia, a tym samym udziału w Konferencji.
          </li>
        <li>Użytkownicy, Uczestnicy, Prelegenci oraz Organizator zobowiązani są do przestrzegania
  ...
  <article>
    <h4>3. Udział w Konferencji w charakterze Uczestnika</h4>
    <ol>
      <li>Zgłoszenie do udziału w Konferencji może zostać dokonane w każdym czasie przed
        rozpoczęciem Konferencji, dopóki taka możliwość jest aktywna w Serwisie Organizatora lub do wyczerpania limitu biletów.
        </li>
        <li>W formularzu zgłoszeniowym należy podać następujące dane: imię i nazwisko, adres e-mail (na ten adres e-mail zostanie przesłany bilet, informacje dotyczące organizacji Konferencji, itp. dlatego prosimy o podanie bezpośredniego i aktualnego adresu e-mail). Dodatkowo możliwe jest podanie danych do faktury: NIP</li>
        <li>W przypadku, w którym Zgłoszenia dokonuje Zgłaszający działający w imieniu osoby trzeciej, powinien on wskazać w formularzu zgłoszeniowym swoje dane.</li>
        <li>Udział w Konferencji w charakterze Uczestnika jest odpłatny. Zgłaszający wybiera opcję biletu według opcji dostępnych w Serwisie</li>
        <li>Koszt wskazany w momencie zakupu jest kosztem uwzględniającym wszystkie opłaty i podatki</li>
        <li>Zapłaty za udział w Konferencji dokonać można wyłącznie w walucie polskiej</li>
        <li>Płatność odbywa się wyłącznie za pośrednictwem Platformy sprzedażowej EasyCart</li>
        <li>W formularzu zgłoszeniowym możliwe jest podanie posiadanego kodu zniżkowego. Brak podania kodu zniżkowego w toku rejestracji powoduje utratę uprawnień
          do uzyskania rabatu, a rejestracja następuje na warunkach odpłatności wskazanych w
          momencie wyboru biletu
          </li>
         <li> Poprzez przesłanie Zgłoszenia, Zgłaszający składa Organizatorowi ofertę zawarcia umowy o udział w Konferencji</li> 
         <li>Otrzymanie przez Organizatora oferty, o której mowa w ustępie poprzedzającym, jest
          potwierdzane poprzez przesłanie na adres e-mail podany w trakcie dokonywania Zgłoszenia
          wiadomości e-mail potwierdzającej jego dokonanie. Z chwilą przesłania tej wiadomości,
          pomiędzy Organizatorem a Zgłaszającym dochodzi do zawarcia umowy o udział w Konferencji.
          </li>
        <li>Z chwilą zawarcia umowy, o której mowa w ustępie poprzedzającym, osoba, na rzecz której zawarta jest ta umowa, uzyskuje status Uczestnika, który umożliwia jej stacjonarne uczestniczenie we wszystkich prelekcjach wskazanych w Agendzie. Miejscem Konferencji jest Kinoteka Pałacu Kultury i Nauki w Warszawie</li>
        <li>Uczestnik i Zgłaszający zobowiązani są do zapoznania się oraz przestrzegania regulaminu korzystania z obiektu, w którym będzie odbywać się Konferencja dostępnego pod <a href="https://pkin.pl/wp-content/uploads/2020/04/Regulamin-organizowania-Imprez-na-terenie-zarz%C4%85dzanym-przez-Sp%C3%B3%C5%82k%C4%99-od-1-maja-2018-r.pdf">linkiem</a></li>
        <li>Organizator może utrwalać przebieg Konferencji dla celów dokumentacyjnych, sprawozdawczych, reklamowych oraz promocyjnych konferencji i Organizatora w przyszłych latach. Wizerunek osób przebywających na terenie, na którym odbywa się Konferencja może zostać utrwalony, a następnie rozpowszechniany dla celów dokumentacyjnych, sprawozdawczych, reklamowych oraz promocyjnych konferencji i Organizatora w przyszłych latach. Uczestnicy decydując się na udział w Konferencji wyrażają jednocześnie zgodę na wykorzystanie przez Organizatora wizerunku swojego lub swoich podopiecznych w przypadku osób małoletnich w celach wskazanych w niniejszym Regulaminie. Wizerunek Uczestnika Konferencji może być użyty do różnego rodzaju form elektronicznego przetwarzania, kadrowania i kompozycji, a także zestawiony z wizerunkami innych osób, może być uzupełniony towarzyszącym komentarzem, natomiast nagranie filmowe i dźwiękowe z jego udziałem mogą być cięte, montowane, modyfikowane, dodawane do innych materiałów powstających w celach dokumentacyjnych, sprawozdawczych, reklamowych oraz promocyjnych Organizatora– bez obowiązku akceptacji produktu końcowego. Zgoda obejmuje wszelkie formy publikacji, w szczególności rozpowszechnianie w Internecie (w tym na portalach społecznościowych Facebook, Twitter, YouTube itp. (w ramach profilu Organizatora).</li>
  ...
  <article>
    ...
    <ol>
      ...
      <li>Wyłączną odpowiedzialność za wszelkie treści zamieszczone w prezentacji ponosi Prelegent</li>
      <li>Z chwilą przekazania Organizatorowi prezentacji, o której mowa w ustępie poprzedzającym, Prelegent udziela Organizatorowi niewyłącznej licencji na korzystanie z materiałów przekazanych Organizatorowi w Propozycji oraz prezentacji, jak również udziela zezwolenia na rozpowszechnianie jego wizerunku utrwalonego na fotografii będącej elementem propozycji</li>
    </ol>
  </article>
  ...
  <article>
    ...
    <ol>
      ...
      <li> Organizator poinformuje Zgłaszającego i Uczestnika o zmianach, o których mowa w pkt. 1 za pomocą komunikatów, które będą dostępne na stronie internetowej Konferencji dostępnej pod linkiem <a href="https://confrontjs.com">https://confrontjs.com</a> </li>
      <li> W przypadku odstąpienia od Umowy przez Organizatora, Organizator dokona zwrotu uiszczonej opłaty za udział w Konferencji na rachunek bankowy, z którego opłata ta została dokonana na rzecz Organizatora, w terminie 30 Dni Roboczych od dnia złożenia oświadczenia o odstąpieniu</li>
    </ol>
  </article>
  ...
  <article>
    ...
    <ol>
      ...
      <li>Dane osobowe Uczestników są przetwarzane do celów wynikających z prawnie uzasadnionych interesów realizowanych przez Administratora tj
        <ul>
          <li>a) realizacji zawartej przez Administratora z Zgłaszającym umowy obejmującej udział Uczestnika w konferencji organizowanej przez Administratora oraz</li>
          <li>b) celów marketingowych</li>
        </ul>
      </li>
      <li>Odbiorcami danych osobowych Uczestników mogą być m.in.:
        <ul>
          <li>a) podmioty zapewniające Administratorowi infrastrukturę informatyczną i sieciową</li>
          <li>b) inni podwykonawcy Administratora, w tym w szczególności podmioty utrwalające na zlecenie Administratora przebieg Konferencji</li>
          <li>c) sponsorzy Konferencji</li>
        </ul>
      </li>
      <li> Uczestnicy mają prawo dostępu do treści swoich danych osobowych oraz prawo ich sprostowania, usunięcia, ograniczenia przetwarzania, prawo do przenoszenia danych, prawo wniesienia sprzeciwu wobec przetwarzania oraz prawo cofnięcia zgody w dowolnym momencie bez wpływu na zgodność z prawem przetwarzania (jeżeli przetwarzanie odbywa się na podstawie zgody), którego dokonano na podstawie zgody przed jej cofnięciem. W celu realizacji tych praw lub zasięgnięcia dalszych informacji na ich temat należy kontaktować się z Administratorem</li>
    </ol>
  </article>
